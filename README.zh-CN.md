...
无需后端转码服务，也不要求把私有文件交给云端转换。一个组件、一套 API，覆盖 Office、PDF、OFD、Typst、CAD、XMind、压缩包、邮件、绘图、音视频、代码、PSD、字体和结构化数据。当前内置 208 个扩展名映射和 25 条预览链路。
...
- **覆盖广。** 208 个扩展名，25 条预览链路，覆盖常见办公、工程、设计、数据和代码附件。
